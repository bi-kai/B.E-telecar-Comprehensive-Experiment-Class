...
void RxPacket(void)
{
	...
	if(RxBuf[0]==1) {LED1=0;
	send("received key 1 presed!\n");
	}
	else if(RxBuf[0]==0xff){ LED1=1;
	send("LED1 out!\n");
	}
	if(RxBuf[1]==1) {LED2=0;
	send("received key 2 presed!\n");
	}
	else if(RxBuf[1]==0xff){ LED2=1;
	send("LED2 out!\n");}


send("read PxPacket over \n");	
}
/*******************************************************************************************/
//function SetTxMode();
/*******************************************************************************************/
