...
/************以下为控制直流电机的按键的引脚********************/
sbit motorforward=P2^4;
sbit motorback=P2^5;
sbit motorleftcircle=P2^6;
sbit motorrightcircle=P2^7;
sbit motorleft=P0^6;
sbit motorright=P0^7;
/*******************************************************************************************/
